...
import 'package:ecom_design_one_list/widgets/home_appbar.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Spacer(),
                    Icon(Icons.camera_alt,size: 24,color: Color(0xFF4C53A5),)
                  ],
                ),
              ),
              Container(
      ...
      bottomNavigationBar: CurvedNavigationBar(
        ...
        Icon(CupertinoIcons.list_bullet_below_rectangle,size: 30, color: Colors.white,),
